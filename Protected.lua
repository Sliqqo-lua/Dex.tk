-- if you do not want a watermark please go to "dtkwt.Parent = game.coregui" and change the coregui part into dex

print("╔════════════════╗")
wait(0.1)
print("║  dex.tk | Credits  ║")
wait(0.1)
print("║--------------------║")
wait(0.1)
print("║ Scripter | Sliqqo  ║")
wait(0.1)
print("║  kavo ui library   ║")
wait(0.1)
print("║--------------------║")
wait(0.1)
print("║    blurred#0777    ║")
...
print("╚════════════════╝")
    ...
    if game.Players.LocalPlayer:IsInGroup(7854111) then
	game.StarterGui:SetCore("SendNotification", {
		Title = "dex.tk";
		Text = "dex.tk | You're whitelisted.";
		Icon = "rbxassetid://6137098315";
	})
end
game.StarterGui:SetCore("SendNotification", {
    Title = "dex.tk";
...
local L_4_ = L_3_.CreateLib("Dex.tk ", "DarkTheme")
...
local L_11_ = L_4_:NewTab("Anti Misc")
...
L_12_:NewButton(
    ...
    function()
    loadstring(game:HttpGet("https://gist.githubusercontent.com/Sliqqo-lua/f4c85f561e0f22b3ac6954c64ea84121/raw/b6868e687cd5d2f596b039bd8bfac0171d04eaf9/gistfile1.txt", true))()
    end
)
L_12_:NewButton(
	"Antiban",
...
local L_11_ = L_4_:NewTab("Misc")
local L_12_ = L_11_:NewSection("Selection")
L_12_:NewButton(
	"Fly (X)",
	"Super Power",
    function()
       loadstring(game:HttpGet("https://gist.githubusercontent.com/Sliqqo-lua/98c27100c4b675cdabcdf69323f60232/raw/ac9e93d170445e7871be25eb91b580978d03eb86/gistfile1.txt"))()
        end)
...
local L_11_ = L_4_:NewTab("Faces/Anims")
local L_12_ = L_11_:NewSection("Selection")
...
local L_11_ = L_4_:NewTab("Others")
local L_12_ = L_11_:NewSection("Selection")
...
local L_11_ = L_4_:NewTab("Trolling")
local L_12_ = L_11_:NewSection("Selection")
L_12_:NewButton(
	"Spam Call Everyone",
	"Spam Calls Everyone",
...
local dtkwt = Instance.new("ScreenGui")
local dex_tk_watermark = Instance.new("ImageLabel")
...
dtkwt.Name = "dtkwt"
dtkwt.Parent = game.CoreGui
dtkwt.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

dex_tk_watermark.Name = "dex_tk_watermark"
dex_tk_watermark.Parent = dtkwt
dex_tk_watermark.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
dex_tk_watermark.BorderSizePixel = 0
dex_tk_watermark.Position = UDim2.new(0.0112334015, 0, 0.0110497242, 0)
dex_tk_watermark.Size = UDim2.new(0, 337, 0, 30)
dex_tk_watermark.Image = "rbxassetid://3641079629"
dex_tk_watermark.ImageColor3 = Color3.fromRGB(120, 120, 120)
dex_tk_watermark.Active = true

TextLabel.Parent = dex_tk_watermark
TextLabel.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
TextLabel.BackgroundTransparency = 1.000
TextLabel.Position = UDim2.new(3.60920312e-05, 0, 0, 0)
...
shadowHolder.Parent = dex_tk_watermark
shadowHolder.BackgroundTransparency = 1.000
shadowHolder.Position = UDim2.new(-0.0124396365, 0, -0.0210526474, 0)
shadowHolder.Size = UDim2.new(1.02924418, 0, 1.03801608, 0)
...
umbraShadow.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
umbraShadow.Size = UDim2.new(1.00222731, 4, 1.00725126, 4)
...
penumbraShadow.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
...
ambientShadow.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
...
shadowHolder_2.Parent = dex_tk_watermark
shadowHolder_2.BackgroundTransparency = 1.000
shadowHolder_2.Position = UDim2.new(-0.0124396365, 0, -0.0210526474, 0)
shadowHolder_2.Size = UDim2.new(1.02924418, 0, 1.03801608, 0)
...
umbraShadow_2.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
umbraShadow_2.Size = UDim2.new(1.00222731, 4, 1.00725126, 4)
...
penumbraShadow_2.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
penumbraShadow_2.Size = UDim2.new(1.00222731, 4, 1.00725126, 4)
...
ambientShadow_2.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
...
shadowHolder_3.Parent = dex_tk_watermark
shadowHolder_3.BackgroundTransparency = 1.000
shadowHolder_3.Position = UDim2.new(-0.0124396365, 0, -0.0210526474, 0)
shadowHolder_3.Size = UDim2.new(1.02924418, 0, 1.03801608, 0)
...
umbraShadow_3.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
umbraShadow_3.Size = UDim2.new(1.00222731, 4, 1.00725126, 4)
...
penumbraShadow_3.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
penumbraShadow_3.Size = UDim2.new(1.00222731, 4, 1.00725126, 4)
...
ambientShadow_3.Position = UDim2.new(0.498979509, 0, 0.503625631, 2)
ambientShadow_3.Size = UDim2.new(1.00222731, 4, 1.00725126, 4)
...
local function HVLCG_fake_script() -- TextLabel.LocalScript 
	...
	while wait() do
		...
		script.Parent.Text = "dex.tk | private | Ver 1.0.2 | " ..h.. ":" ..m.. ":" ..s.. " " ..mo.. " | " ..mon[mont][1].. " " ..d.. ", " ..y
	end
end
coroutine.wrap(HVLCG_fake_script)()
